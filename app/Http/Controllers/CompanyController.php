...
class CompanyController extends Controller
{
    ...
    public function generateConfirmationCode(Request $request)
    {
        ...
        try  {
            ...
            Mail::raw(
                'A confirmation code has been generated by ' . $request->admin_name . ' for the company "' . $request->company_name . '". The code is: ' . $confirmationCode . ' Admin Email: ' . $request->email,
