...
<link rel="icon" href="{{ asset('/uploads/company_logos/'. \App\Helpers\AppHelper::instance()->CompanySettingCEO()->logo) }}" type="image/x-icon"/>
...
<div id="main_content">
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                <a class="header-brand" href="/ceo"><img src="{{ asset('/uploads/company_logos/'. \App\Helpers\AppHelper::instance()->CompanySettingCEO()->logo) }}" width="50" style="border-radius:50px;"></a>
                <div class="dropdown">
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        ...
                        <h1 class="page-title"><a href="/ceo">Dashboard</a></h1>
                    </div>
                    <div class="right">
                        ...
                        <div class="notification d-flex">
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="/ceo/profile"><i class="dropdown-icon fa fa-user"></i> Profile</a>
                                    <a class="dropdown-item" href="/ceo/setting"><i class="dropdown-icon fa fa-gear"></i> Settings</a>
