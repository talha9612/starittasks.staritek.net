...
<div id="main_content">
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                <a class="header-brand" href="/user"><i class="fa fa-soccer-ball-o brand-logo"></i></a>
                <div class="dropdown">
    ...
    <div class="user_div">
        <h5 class="brand-name mb-4 text-capitalize">User Dashboard<a href="javascript:void(0)" class="user_btn"><i class="fa fa-times"></i></a></h5>
        <div class="card-body">
