                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Totall Assign Projects</h3>
                            </div>
                            <div class="card-body">
                                           ...
                                           @foreach($tasks as $task)
                                            <tr>
                                                ...
                                                <td class="text-capitalize">
                                                    <form method="post" action="/user/project" id="my_form">
                                                        @csrf
                                                        <input type="hidden" name="project_id" value="{{$task->project->id}}">
                                                        <a href="javascript:void(0)" onclick="document.getElementById('my_form').submit();">{{$task->project->project_name}}</a>
                                                    </form>
                                                </td>
                                                <td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body" style="background-color: #ebebeb;">
                        <a href="javascript:void(0)" class="btn btn-danger mb-3 mark_as_complete" data-id="">Mark As Complete</a></br>
