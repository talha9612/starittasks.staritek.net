                                        ...
                                        <tbody>
                                            @foreach($tasks as $key=>$task)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post" action="/ceo/projectdetails" id="my_form_{{ $key }}">
                                                            @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="card">
                                    ...
                                    <form class="card-body" method="post" action="{{url('/ceo/add-task')}}" enctype="multipart/form-data">
                                        @csrf()
                                        <div class="row clearfix">
...
<div class="modal fade bd-example-modal-lg" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width:1250px;" role="document">
        ...
        <div class="modal-header">
            ...
            <form method="post" action="{{url('/ceo/single-task-model-complete/')}}" enctype="multipart/form-data">
                @csrf
    ...
    $('.getmodel').on('click',function(){
        ...
        $.ajax({
                ...
                success:function(response){
                    ...
                    // $('textarea#editor').ClassicEditor().editor.insertText('some text here');
                    var regex = /(<([^>]+)>)/ig;
                    ...
                    $('.task-desc').val(rehtml.replace(/\&nbsp;/g, ''));
