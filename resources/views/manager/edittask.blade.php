            ...
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="card">
                                    ...
                                    <form class="card-body" method="post" action="{{url('/manager/update-task')}}" enctype="multipart/form-data">
                                        @csrf()
                                        <div class="row clearfix">
                                                    ...
                                                    <select class="form-control" name="catagory">
                                                        @foreach($catagories as $catagory)
                                                            @if($catagory->id == $task->task_category_id)
                                                                <option value="{{$catagory->id}}" selected>{{$catagory->category_name}}</option>
                                                            @endif
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>Priority</label>
                                                        ...
                                                        <input class="form-check-input" type="radio" name="priority" value="1" id="flexRadioDefault1" <?php echo ($task['priority']==1 ? 'checked' : '')?>/>
                                                        <label class="form-check-label text-danger" for="flexRadioDefault1"> High </label>
                                                        </div>
                                                        <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="priority" value="2" id="flexRadioDefault2"  <?php echo ($task['priority']==2 ? 'checked' : '')?>/>
                                                        <label class="form-check-label text-warning" style="color:#ffc107!important" for="flexRadioDefault2"> Medium </label>
                                                        </div>
                                                        <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="priority" value="3" id="flexRadioDefault3"  <?php echo ($task['priority']==3 ? 'checked' : '')?>/>
