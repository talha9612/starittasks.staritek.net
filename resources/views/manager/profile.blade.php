                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped text-nowrap table-vcenter mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Date Of Birth</th>
                                                <td>{{date('Y-m-d H:i:s', strtotime($user->dob))}}</td>
                                            </tr>
                                            <tr>
                                                <th>Gender</th>
                                                <td>
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="card">
                                    ...
                                    <form class="card-body" method="post" action="{{url('/manager/update-profile')}}" enctype="multipart/form-data">
                                        @csrf()
                                        <div class="row clearfix">
