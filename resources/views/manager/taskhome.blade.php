                            ...
                            <div class="d-md-flex justify-content-between mb-2">
                                <ul class="nav nav-tabs b-none">
                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#list"><i
                                                class="fa fa-list-ul"></i> Tasks List</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addnew"><i
                                                class="fa fa-plus"></i> Add New Tasks</a></li>
                                            ...
                                            <tbody>
                                                @foreach ($tasks as $task)
                                                    <tr>
                                                        ...
                                                        <td class="text-capitalize task_heading_width"><a
                                                                href="javascript:void(0)" class="getmodel"
                                                        ...
                                                        <td>
                                                            <ul class="list-unstyled team-info sm margin-0 w150">
                                                                @if ($task->GetUsers != null)
                                                                    <li><img src="{{ asset('uploads/staf_images/' . $task->GetUsers->image) }}"
                                                                            alt="Avatar">
                                                        ...
                                                        <td>
                                                            <ul class="list-unstyled team-info sm margin-0 w150">
                                                                @if ($task->AssignBy != null)
                                                                    <li><img src="{{ asset('uploads/staf_images/' . $task->AssignBy->image) }}"
                                                                            alt="Avatar">
                                                        ...
                                                        <td>
                                                            <div class="form-group mt-3">
                                                                <input type="radio" style="display:none;"
                                                                    value="{{ $task->progress }}"
                                                                    id="a-{{ $task->progress }}" checked>
                                                                <div class="progress">
                                                                    <div class="progress-bar" style="position: relative">
                                                                        @if ($task->progress == 'five')
                                                                            <span
                                                                                style="position: absolute; left:105px;color:#292b30;">5%</span>
                                                                        @elseif ($task->progress == 'twentyfive')
                                                                            <span
                                                                                style="position: absolute; left:105px;color:#292b30;">25%</span>
                                                                        @elseif ($task->progress == 'fifty')
                                                                            <span
                                                                                style="position: absolute; left:105px;color:#292b30;">50%</span>
                                                                        @elseif ($task->progress == 'seventyfive')
                                                                            <span
                                                                                style="position: absolute; left:105px;color:#292b30;">75%</span>
                                                                        @elseif ($task->progress == 'onehundred')
                                                                            <span
                                                                                style="position: absolute; left:105px;color:#292b30;">100%</span>
                                                                        @else
                                                                            <span
                                                                                style="position: absolute; left:105px;color:#292b30;">0%</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <label class="custom-switch m-0">
                                                                <input type="checkbox" value="0"
                                                                    class="custom-switch-input manager-task-approved"
                                                                    data-id="{{ $task->id }}" data-toggle="toggle"
                                                                    data-onstyle="outline-success"
                                                                    {{ $task->approved == 1 ? 'checked' : '' }}>
                                                        ...
                                                        <td>
                                                            <form action="/manager/edit-task" method="post"
                                                                class="d-inline">
                                                                @csrf
                                                            ...
                                                            |
                                                            <form action="/manager/delete-task" method="post"
                                                                class="d-inline">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $task->id }}">
                                                                <button class="btn btn-danger"
                                                                    onclick="archiveFunction()">Del</button>
                                                            </form>
                                                            <script>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <form class="card-body" method="post" action="{{ url('/manager/add-task') }}"
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label>Task Category <button type="button" class="btn btn-success btn-sm"
                                                        onclick="GetCatagory()" data-toggle="modal"
                                                        data-target="#addtask">Add Catagory</button></label>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" name="start_date" data-date-autoclose="true"
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" name="due_date" data-date-autoclose="true"
                                                    class="form-control" placeholder="Due Date" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="priority"
                                                        value="2" id="flexRadioDefault2" checked="true" />
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <div class="card">
                                ...
                                <form class="card-body" method="post" action="{{ url('/manager/assign-project') }}"
                                    enctype="multipart/form-data">
                                    @csrf()
                                    <div class="row clearfix">
                                        <div class="col-md-6 col-sm-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form id="target_category"><button type="submit" class="btn btn-primary"
                            onclick="SaveCatagory()">Add</button></form>
                            ...
                            <div class="row mt-3">
                                <div class="col-xs-6 col-md-3 font-12 m-t-10">
                                    ...
                                    <ul class="list-unstyled d-inline team-info sm margin-0 w150">
                                        <li><img id="assign_to" src="" class="img-circle" width="25"
                                                alt=""></li>
                                    </ul>
                                ...
                                <div class="col-xs-6 col-md-3 font-12 m-t-10">
                                    ...
                                    <ul class="list-unstyled d-inline team-info sm margin-0 w150">
                                        <li><img id="assign_by" src="" class="img-circle" width="25"
                                                alt=""></li>
                                    </ul>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (progresscheck == 'five') {
                        $(".check_progress").append(
                            "<input type='radio' style='display:none;' value='five' id='a-five' checked><div class='progress'><div class='progress-bar' style='position: relative'><span style='position: absolute; left:105px;color:#292b30;'>5%</span></div></div>"
                            );
                    } else if (progresscheck == 'twentyfive') {
                        $('.check_progress').append(
                            "<input type='radio' style='display:none;' value='twentyfive' id='a-twentyfive' checked><div class='progress'><div class='progress-bar' style='position: relative'><span style='position: absolute; left:105px;color:#292b30;'>25%</span></div></div>"
                            );
                    } else if (progresscheck == 'fifty') {
                        $('.check_progress').append(
                            "<input type='radio' style='display:none;' value='fifty' id='a-fifty' checked><div class='progress'><div class='progress-bar' style='position: relative'><span style='position: absolute; left:105px;color:#292b30;'>50%</span></div></div>"
                            );
                    } else if (progresscheck == 'seventyfive') {
                        $('.check_progress').append(
                            "<input type='radio' style='display:none;' value='seventyfive' id='a-seventyfive' checked><div class='progress'><div class='progress-bar' style='position: relative'><span style='position: absolute; left:105px;color:#292b30;'>75%</span></div></div>"
                            );
                    } else if (progresscheck == 'onehundred') {
                        $('.check_progress').append(
                            "<input type='radio' style='display:none;' value='onehundred' id='a-onehundred' checked><div class='progress'><div class='progress-bar' style='position: relative'><span style='position: absolute; left:105px;color:#292b30;'>100%</span></div></div>"
                            );
                    }
                    ...
                    $("#assign_to").attr("src", "/uploads/staf_images/" + response.data.assign_to
                    .image);
                    $(".assign_to_name").text(response.data.assign_to.name);
                    $("#assign_by").attr("src", "/uploads/staf_images/" + response.data.assign_by
                    .image);
                    $(".assign_by_name").text(response.data.assign_by.name);
                    $('.task-catagory').append("Task Category > <span class='text-capitalize'>" +
                        response.data.get_task_catagory.category_name + "</span>");
                    $('.task-title').append(
                        "<h6 class='d-inline'>Task Title : <span class='text-capitalize' style='color:#17a2b8!important'>" +
                        response.data.heading + "</span></h6>");
                    $('.project-title').append(
                        "<h6 class='d-inline'>Project Name : <span class='text-danger text-capitalize'>" +
                        response.data.project.project_name + "</span></h6>");
                    if (response.data.priority == 1) {
                        $('.task-priority').append(
                    ...
                    if (screens == undefined) {
                        ...
                        for (var i = 0; i < screens.length; i++) {
                            $('.screenshots').append("<a href='" + window.location.origin +
                                "/uploads/screenshots/" + screens[i] +
                                "' target='_blank'><img src='" + window.location.origin +
                                "/uploads/screenshots/" + screens[i] +
                                "' width='150' class='img-thumbnail'></a>");
                        }
                    }
                    // For Histtory ////////////////////////
                    for (var i = 0; i < response.activities.length; i++) {
                        ...
                        var historyscreenshots = response.activities[i].properties.attributes
                            .screen_shot;
                        var his_screens = $.parseJSON(historyscreenshots);
                        $(".new_timeline").append(
                            "<li><div class='bullet pink'></div><div class='time'>" + moment(
                                response.activities[i].created_at).format('DD-MM-YYYY h:mm:ss a') +
                            "<span class='tag tag-default' style='border-radius:20px;'>" + name +
                            "</span><span>" + ((response.activities[i].properties.attributes[
                                    'priority'] == 1) ?
                                '<spane class="tag tag-success" style="border-radius:20px;">Priority:- High</spane>' :
                                '') + "</span><span>" + ((response.activities[i].properties
                                    .attributes['priority'] == 2) ?
                                '<spane class="tag tag-default" style="border-radius:20px; background-color:#fbbd08;">Priority:- Medium</spane>' :
                                '') + "</span><span>" + ((response.activities[i].properties
                                    .attributes['priority'] == 3) ?
                                '<spane class="tag tag-default" style="border-radius:20px; background-color:#28a745;">Priority:- Low</spane>' :
                                '') +
                            "</span></div><div class='desc'><h3 class='text-capitalize'>" + response
                            .activities[i].description + "</h3><h4 class='text-capitalize'>" + ((
                                JSON.stringify(response.activities[i].properties.attributes) !=
                                undefined) ? JSON.stringify(response.activities[i].properties
                                .attributes['heading']).replace(/^"(.*)"$/, '$1') : 'Not Found') +
                            "</h4>" + ((JSON.stringify(response.activities[i].properties.attributes[
                                'description']) != undefined) ? JSON.stringify(response
                                .activities[i].properties.attributes['description']).replace(
                                /^"(.*)"$/, '$1') : '') + "</div>" + ((historyscreenshots != null) ?
                                ((his_screens[0] != undefined) ? "<img src='" + window.location
                                    .origin + "/uploads/screenshots/" + his_screens[0] +
                                    "' width='150' class='img-thumbnail'/>" : "") + ((his_screens[
                                        1] != undefined) ? "<img src='" + window.location.origin +
                                    "/uploads/screenshots/" + his_screens[1] +
                                    "' width='150' class='img-thumbnail'/>" : "") + ((his_screens[
                                        2] != undefined) ? "<img src='" + window.location.origin +
                                    "/uploads/screenshots/" + his_screens[2] +
                                    "' width='150' class='img-thumbnail'/>" : "") + ((his_screens[
                                        3] != undefined) ? "<img src='" + window.location.origin +
                                    "/uploads/screenshots/" + his_screens[3] +
                                    "' width='150' class='img-thumbnail'/>" : "") + ((his_screens[
                                        4] != undefined) ? "<img src='" + window.location.origin +
                                    "/uploads/screenshots/" + his_screens[4] +
                                    "' width='150' class='img-thumbnail'/>" : "") : "") + "</li>");
                    }
                    // End For History /////////////////////
                }
            });
                ...
                success: function(response) {
                    ...
                    for (let i = 0; i < response.catagories.length; i++) {
                        ...
                        $(".show_pro_cata").append("<option value=" + response.catagories[i].id + ">" + (count +
                            i) + ") " + response.catagories[i].category_name + "</option>");
                    }
                }
            });
        }
        ...
        function DeleteCatagory(id) {
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '/manager/delete-task-catagory/',
                data: {
                    "_token": "{{ csrf_token() }}",
                    'id': id
                },
