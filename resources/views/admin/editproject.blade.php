                            ...
                            <div class="card-body">
                                <div class="d-md-flex justify-content-between mb-2">
                                    <ul class="nav nav-tabs b-none">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#list"><i class="fa fa-list-ul"></i> Edit Project</a></li>                                        
                                    </ul>
                                </div>
            ...
            <div class="container-fluid">
                <div class="tab-content">
                    ...
                    <div class="card">
                                    ...
                                    <form class="card-body" method="post" action="{{url('/admin/update-project')}}" enctype="multipart/form-data">
                                        @csrf()
                                        <div class="row clearfix">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" value="{{$project->project_name}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" value="{{date('Y-m-d H:i:s', strtotime($project->start_date))}}" name="start_date" data-date-autoclose="true" class="form-control" placeholder="Date of Birth">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    <label>Deadline</label>
                                                    <input type="datetime-local" name="end_date" value="{{date('Y-m-d H:i:s', strtotime($project->deadline))}}" data-date-autoclose="true" class="form-control" placeholder="Date of Birth">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="head">
                                                        @foreach($users as $user)
                                                            <option value="{{$user->id}}" <?php echo ($user->id == $project->project_head ? 'selected' : '')?>>{{$user->name}}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group mt-3">
                                                    ...
                                                    <textarea rows="10" id="editor" name="summary" class="form-control no-resize" placeholder="Please type what you want...">{{$project->project_summary}}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
