                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="dob" value="{{date('Y-m-d H:i:s', strtotime($user->dob))}}" data-date-autoclose="true" class="form-control" placeholder="Date of Birth">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12">
                                            <label>Gender</label>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                @if($company->logo)
                                                <div class="mt-2">
                                                    <img src="{{ asset('uploads/company_logos/' . $company->logo) }}" width="100" alt="Company Logo">
                                                </div>
                                                @endif
                                            </div>
                                        </div>
