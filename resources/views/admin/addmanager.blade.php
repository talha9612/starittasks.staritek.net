                            ...
                            <div class="d-md-flex justify-content-between mb-2">
                                <ul class="nav nav-tabs b-none">
                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#list"><i
                                                class="fa fa-list-ul"></i>Company Staff List</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addnew"><i
                                                class="fa fa-plus"></i> Add Team</a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addceo"><i
                                                class="fa fa-plus"></i> Add CEO</a></li>
                                </ul>
                            </div>
...
>>>>>>> c81d3a895e23d3dd3e5d51dd589b8d9a2a44915c
                        </div>
                                            ...
                                            <tbody>
                                                @foreach ($users as $user)
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ asset('uploads/staf_images/' . $user->image) }}"
                                                                width="80"
                                                            ...
                                                            @if ($user->status == 1)
                                                                <label class="custom-switch m-0">
                                                                    <input type="checkbox" value="0"
                                                                        class="custom-switch-input admin-change-status-user"
                                                        ...
                                                        <td>
                                                            <form action="/admin/edit-manager" method="post"
                                                                class="d-inline">
                                                                @csrf
                                                            ...
                                                            | <form action="/admin/delete-manager" method="post"
                                                                class="d-inline">
                                                                @csrf
                                                                <input type="hidden" name="id"
                                                                    value="{{ $user->id }}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <form class="card-body" method="post" action="{{ url('/admin/add-manager') }}"
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" id="check-email" name="email" class="form-control"
                                        ...
                                        <div class="col-md-4 col-sm-12 manager_value d-none">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select-members text-capitalize"
                                                    name="team_memeber">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <form class="card-body" method="post" action="{{ url('/admin/add-ceo') }}"
                                    enctype="multipart/form-data">
                                    @csrf()
                                    <div class="row clearfix">
                                        <div class="col-md-4 col-sm-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form id="target_department"><button type="submit" class="btn btn-primary"
                            onclick="SaveDepartment()">Add</button></form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form id="target_category"><button type="submit" class="btn btn-primary"
                            onclick="SaveSkill()">Add</button></form>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    for (var i = 0; i < response.users.length; i++) {
                        $(".select-members").append("<option value=" + response.users[i].id + ">" +
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (let i = 0; i < response.departments.length; i++) {
                        $(".show_department_p").append("<p id='" + response.departments[i].id + "'>" + (count +
                                i) + ") " + response.departments[i].name +
                            " <span style='float: right;'><button class='btn btn-danger btn-sm' onclick='DeleteDepartment(" +
                            response.departments[i].id + ")'>X</button></span></p>");
                        $(".show_department").append("<option value=" + response.departments[i].id + ">" + (
                            count + i) + ") " + response.departments[i].name + "</option>");
                    }
                }
            });
        }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (let i = 0; i < response.skills.length; i++) {
                        $(".show_skill_p").append("<p id='" + response.skills[i].id + "'>" + (count + i) +
                            ") " + response.skills[i].name +
                            " <span style='float: right;'><button class='btn btn-danger btn-sm' onclick='DeleteSkill(" +
                            response.skills[i].id + ")'>X</button></span></p>");
                        $(".show_skill").append("<option value=" + response.skills[i].id + ">" + (count + i) +
                            ") " + response.skills[i].name + "</option>");
                    }
                }
            });
        }
