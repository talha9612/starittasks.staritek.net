$(document).ready(function() {
  ...
  $('.btn-pageheader').on('change',function(){
    ...
    type:'GET',
    dataType:'JSON',
    url:'/manager/manager-change-topheader-setting',
    data:{
        'status':status,
        'status_id':status_id
    },
  ...
  $('.btn-min_sidebar').on('change',function(){
    ...
    type:'GET',
    dataType:'JSON',
    url:'/manager/manager-change-minsidebar-setting',
    data:{
        'status':status,
        'status_id':status_id
    },
  ...
  $('.btn-sidebar').on('change',function(){
    ...
    type:'GET',
    dataType:'JSON',
    url:'/manager/manager-change-sidebar-setting',
    data:{
        'status':status,
        'status_id':status_id
    },
  ...
  $('.btn-darkmode').on('change',function(){
    ...
    type:'GET',
    dataType:'JSON',
    url:'manager/manager-change-theme-setting',
    data:{
        'status':status,
        'status_id':status_id
    },
  ...
  $('.btn-boxshadow').on('change',function(){
    ...
    type:'GET',
    dataType:'JSON',
    url:'/manager/manager-change-boxshadow-setting',
    data:{
        'status':status,
        'status_id':status_id
    },
...
//////////////////Change Users Status////////////
$('.manager-task-approved').on('change',function(){
    var status = $(this).prop('checked') == true ?1:0;
    var status_id = $(this).data('id');
    $.ajax({
      type:'GET',
      dataType:'JSON',
      url:'/manager/manager-approved-task',
      data:{
        'status':status,
        'status_id':status_id
      },
